...
export default function ReservationContent({ meal, reviews = [] }) {
  ...
  // Gallery images: filter out falsy values
  const galleryImages =
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {galleryImages.map((image, index) => (
                <button
                  ...
                  className={`relative w-24 h-24 rounded-tl-2xl rounded-br-2xl overflow-hidden border-2 ${
                    currentImageIndex === index ? 'border-[#8A1739]' : 'border-gray-300'
                  }`}
                >
                  {image ? (
                    <Image
              ...
              <div className="flex gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <span
                    key={star}
                    className={`text-xl ${
                      star <= Math.round(averageRating) && totalReviews > 0 ? 'text-yellow-400' : 'text-gray-300'
                    }`}
                  >
                    ★
                  </span>
          ...
          <div className="flex flex-col">
            {/* Title */}
            <h1 className="text-3xl font-playfair font-bold text-[#8A1739] mb-3">
              {meal.category}
            </h1>
            ...
            {/* Schedule */}
            <div className="mb-4 p-3 bg-[#8A1739] text-white rounded-tl-2xl rounded-br-2xl">
              <p className="font-medium text-sm">{meal.schedule}</p>
            </div>
            ...
            {/* Price Display */}
            <div className="mb-4">
              <p className="text-2xl font-bold text-[#8A1739]">
                USD {meal.adultPrice}
              </p>
            </div>
            ...
            {/* Available Options */}
            <div className="mb-4">
              <h3 className="text-base font-semibold mb-3">Available Options</h3>
              <p className="text-xs text-gray-600 mb-2">*Ticket Type & Quantity</p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                ...
                <div className="border-2 border-[#8A1739] rounded-tl-2xl rounded-br-2xl p-3">
                  ...
                  <div className="flex items-center justify-center gap-3">
                    <button
                      ...
                      className="w-8 h-8 border-2 border-gray-300 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors text-sm"
                    >
                      -
                    </button>
                    <span className="text-xl font-bold w-10 text-center">{kidsTickets}</span>
                    <button
                ...
                <div className="border-2 border-[#8A1739] rounded-tl-2xl rounded-br-2xl p-3">
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <span className="text-xl font-bold w-10 text-center">{adultsTickets}</span>
                    <button
              ...
              {/* Date Selection */}
              <div className="mb-3">
                <p className="text-xs text-gray-600 mb-2">*Date Selection</p>
            ...
            {/* Total Cost */}
            <div className="mb-4 pt-6 border-t-2 border-gray-300">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 border-2 border-[#8A1739] text-[#8A1739] rounded-tl-2xl rounded-br-2xl font-medium hover:bg-[rgba(138,23,57,0.1)] transition-colors text-sm"
              >
                View Menu
              </button>
              <button
                onClick={handleAddToCart}
                className="flex-1 py-2.5 bg-[#8A1739] text-white rounded-tl-2xl rounded-br-2xl font-medium hover:bg-[#8A1739]/90 transition-colors flex items-center justify-center gap-2 text-sm"
              >
                <Image
                  src="/cart.png"
                  alt="cart"
