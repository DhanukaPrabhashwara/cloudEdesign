...
export default function ReservationContent({ meal }) {
    ...
    // Gallery images (add meal.image and additional images if you have them)
    ...
    const handleViewMenu = () => {
        // Navigate to menu page or open menu modal
                ...
                <div>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            {/* Kids Ticket */}
                            <div className="border-2 border-gray-300 rounded-tl-2xl rounded-br-2xl p-4">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full p-3 border-2 border-gray-300 rounded-tl-2xl rounded-br-2xl focus:outline-none focus:border-[#8A1739]"
